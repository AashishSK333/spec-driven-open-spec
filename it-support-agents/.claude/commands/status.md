---
name: "Status"
description: Display a real-time dashboard of open incidents, service requests, SLA compliance, and recent activity
category: Operations
...
**Input:** None required. Optionally specify a filter: `incidents`, `requests`, `sla`, or `all` (default).

## Instructions

Follow these steps to compile the status dashboard. This command does not require a specific agent persona — it aggregates data from multiple skills.

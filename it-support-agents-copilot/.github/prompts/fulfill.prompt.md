---
mode: "agent"
description: "Handle a service request — validate, route approvals, execute fulfillment"
tools:
  - jira
  - slack
  - cmdb
...
### 6. Find the fulfillment procedure
